...
[please create a GitHub discussion](https://github.com/impratikjaiswal/qrPlay/discussions/new/choose).
...
If you've noticed a bug, [please submit an issue](https://github.com/impratikjaiswal/qrPlay/issues/new).

## Bug Reports Guidelines

1. **Use the GitHub issue search.** Check if the issue has already been
   [reported](https://github.com/impratikjaiswal/qrPlay/issues).
...
[a feature request](https://github.com/impratikjaiswal/qrPlay/discussions/new?category=ideas) to first discuss any 
...
If this is something you think you can fix, then [fork](https://github.com/impratikjaiswal/qrPlay/fork) and create
